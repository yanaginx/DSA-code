 ...
 * =====================================================================================
 *
 *       Filename:  post_pre_exp.cpp
 *
 *    Description:  Evaluate postfix and prefix expressions using stack
 *
 *        Version:  1.0
 *        Created:  04/08/2020 02:07:06 PM
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  mycodeschool
...
int main() 
{
   ...
   getline(cin, expression);
   int result2 = EvaluatePrefix(expression);
   cout << "Output = "<<result2<<"\n";
}
